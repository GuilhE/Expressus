...
object Versions {
    ...
    object JetBrains {
        ...
        object Compose {
            const val desktop = "1.2.0-alpha01-dev741"
        }
    }
...
object Libs {
    ...
    object Multiplatform {
        ...
        const val multiplatformSettings =
            "com.russhwolf:multiplatform-settings:${Versions.Multiplatform.multiplatformSettings}"
    }
    ...
    object Android {
        ...
        object Core {
            const val material =
                "com.google.android.material:material:${Versions.Android.Core.material}"
        }

        object Lifecycle {
            const val lifecycleRuntimeKtx =
                "androidx.lifecycle:lifecycle-runtime-ktx:${Versions.Android.Core.lifecycleKtx}"
        }

        object Compose {
            const val activity =
                "androidx.activity:activity-compose:${Versions.Android.Compose.activity}"
            const val material =
                "androidx.compose.material:material:${Versions.Android.Compose.core}"
            ...
            const val uiToolingPreview =
                "androidx.compose.ui:ui-tooling-preview:${Versions.Android.Compose.core}"
            const val runtime = "androidx.compose.runtime:runtime:${Versions.Android.Compose.core}"
            const val foundationLayout =
                "androidx.compose.foundation:foundation-layout:${Versions.Android.Compose.core}"
        }
    }

    object JetBrains {
        const val serializationJson =
            "org.jetbrains.kotlinx:kotlinx-serialization-json:${Versions.JetBrains.kotlinxSerialization}"
        const val atomicFu = "org.jetbrains.kotlinx:atomicfu:${Versions.JetBrains.kotlinxAtomicFu}"
        const val kotlinxCoroutinesCore =
            "org.jetbrains.kotlinx:kotlinx-coroutines-core:${Versions.JetBrains.kotlinxCoroutines}"
    }
    ...
    object Gradle {
        ...
        const val kotlinSerialization =
            "org.jetbrains.kotlin:kotlin-serialization:${Versions.JetBrains.kotlin}"
    }
}
